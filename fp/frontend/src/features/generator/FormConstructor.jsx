...
function FormConstructor() {
    ...
    return (
        <CollapsibleSection className=" rounded-lg" onChange={handleSync}>
            <div className="class-constructor">
                ...
                <div className="col-span-full md:col-span-2 form-field-container">
                    ...
                    <InputControl
                        ...
                        className="input-container flex-1 text-primary-400 text-2xl w-1/3"
                ...
                <div className="form-field-container">
                    ...
                    <div className="form-add-row">
                        <InputControl
                            ...
                            classInput="input-style"
                        />
                        <Button onClick={() => { handleAddParam(newParam); setNewParam(""); }}
                ...
                <div className="form-field-container">
                    ...
                    <div className="form-add-row">
                        <InputControl
                            ...
                            classInput="input-style"
                        />
                        <Button onClick={() => { handleAddProperty(newProperty); setNewProperty(""); }}
                            className="header-add-button">Agregar</Button>
                    </div>
                </div>
            </div>
